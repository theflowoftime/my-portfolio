...
export default function Marquee({
  ...
  return (
    <div
      {...props}
      className={cn(
        "group relative flex h-full w-full p-2 [--duration:10s] [--gap:12px] [gap:var(--gap)] lg:text-[9rem] md:text-[6rem] sm:text-[3rem] will-change-transform uppercase whitespace-nowrap font-unbounded",
