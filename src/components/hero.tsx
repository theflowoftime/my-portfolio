...
function Hero() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-around h-full min-h-[calc(100vh-4.56rem)]">
      {/* <Rectangle /> */}
      <div className="container h-full space-y-4 text-center text-white">
        <div className="leading-[6.33rem] font-instrument text-[5.11rem] -tracking-[0.17rem]">
          <p className="flex items-center justify-center">
            <span className="space-x-4">
              ...
              <Avatar className="hidden md:inline-block min-w-min min-h-min my-auto h-[3.75rem] w-[7.5rem] shadow-md bg-black backdrop-blur-2xl bg-opacity-5">
                <AvatarImage
          ...
          <p className="flex items-center justify-center gap-x-2">
            <span className="space-x-4">
              <span>a Product</span>
              <Avatar className="hidden md:inline-block min-w-min min-h-min h-[3.75rem] w-[7.5rem] shadow-md bg-black">
                <AvatarImage
        ...
        <p className="tracking-tight text-balance text-white/40">
      ...
      >
        <div className="flex flex-col items-center">
          <ChevronsDown
            ...
            size={72}
          />
          <span className="animate-pulse opacity-20 font-unbounded">
            Explore
          </span>
        </div>
      </Link>
